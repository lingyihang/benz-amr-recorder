	...
	var AMRWB = (function() {
		var AMRWB = {
			...
			_decodeRtp: (function(rtp) {
				...
				while ((((tocPtr == this.RTP_HEADER_SIZE + 1) && (rtp[tocPtr - 1] == this.RTP_TOC_HEADER)) || ((rtp[tocPtr - 1] & 0x80) == 0x80)) && (payLoadptr < rtp.length)) {
		...
		var Module = {
			...
			// AMRWB.Encoder_Interface_init = Module._Encoder_Interface_init;
			// AMRWB.Encoder_Interface_exit = Module._Encoder_Interface_exit;
			// AMRWB.Encoder_Interface_Encode = Module._Encoder_Interface_Encode;
		...
		function(global, env, buffer) {
			...
			function ua(e, f, g, h) {
				...
				if (h << 16 >> 16 != 0 ? (b[e + 34 >> 1] | 0) != 0 : 0) {
					...
					b[e + 36 >> 1] = rb(b[p >> 1] | 0, c[o >> 2] | 0, g, j, c[e >> 2] | 0, b[i >> 1] | 0, c[e + 8 >> 2] | 0) | 0;
					h = 0
				}
				do {
					k = g + (h << 1) | 0;
			...
			function Ca(a, c, d, e) {
				...
				g = c << 17;
				f = d & 65535;
				Ba((1 << (c << 1) + -1) + -1 & a, c + 65535 & 65535, (1 << (g + -65536 >> 16) & a | 0) == 0 ? d : (1 << c + -1) + f & 65535, e);
				a = a >> (g >> 16) & (1 << c + 1) + -1;
				c = 1 << c;
				d = (a & c + 65535) + f | 0;
				...
				case 1:
					{
						...
						n = l << 17;
						Ba((1 << (f >> 15) + -1) + -1 & a, o + 65535 & 65535, (1 << (n + -65536 >> 16) & a | 0) == 0 ? k : (1 << o + -1) + j & 65535, e + 2 | 0);
						a = (1 << o + 1) + -1 & a >> (n >> 16);
						d = (a & d) + (j & 65535) | 0;
				...
				case 3:
					{
						k = a >> (f + 65536 >> 16);
						m = l << 17;
						Ba((1 << (f >> 15) + -1) + -1 & k, o + 65535 & 65535, (1 << (m + -65536 >> 16) & k | 0) == 0 ? d : (1 << o + -1) + n & 65535, e);
						m = k >> (m >> 16) & (1 << o + 1) + -1;
						d = c + 65535 | 0;
						o = (m & d) + n | 0;
			...
			function Ha(a, d, f, g, h, i, j, k, n, o, p, q) {
				...
				c[y >> 2] = f;
				c[i >> 2] = f;
				if (k << 16 >> 16 == 1 ? (r = b[w >> 1] | 0, r = (r * 5120 | 0) == 1073741824 ? 2147483647 : r * 10240 | 0, c[y >> 2] = r, (f | 0) > 6553600 & (f | 0) > (r | 0)) : 0) c[i >> 2] = r;
				else r = f;
				k = r << 3;
			...
			function Ia(a, c, d, f, g, h) {
				...
				while (1) {
					...
					f = g << 3;
					g = ((f >> 3 | 0) == (g | 0) ? f : g >> 31 ^ 2147483647) + (N(b[d + (k + -1 << 1) >> 1] | 0, l) | 0) | 0;
					f = g << 1;
			...
			function La(a, d, e) {
				...
				do {
					...
					k = (g << 16 >> 16) - (i << 16 >> 16) | 0;
					j = k >> 31;
					b[h >> 1] = (((k >> 15 | 0) == (j | 0) ? k : j ^ 32767) & 65535) << 16 >> 16 < 448 ? (i & 65535) + 448 | 0 : g;
					f = f + 1 | 0
				} while ((f | 0) != 15);
				d = a + 28 | 0;
			...
			function Ma(c, d, e) {
				...
				zb(d >> 1, h, i);
				n = b[h >> 1] | 0;
				b[c + 332 + (b[j >> 1] << 1) >> 1] = ((b[i >> 1] | 0) >>> 8) + 64512 + ((n << 23 >> 23 | 0) == (n | 0) ? n << 7 : n >>> 15 ^ 32767);
				l = k;
				return
			}
			...
			function Ra(a, c, d) {
				...
				while (1) {
					...
					c = a + (j << 1) | 0;
					g = b[c >> 1] | 0;
					f = ((N(h << 16 >> 16, -1830) | 0) + ((i << 16 >> 16) * 29280 | 0) + f + (((g << 16 >> 16) + (k << 16 >> 16) | 0) * 915 | 0) << 2) + (r >> 13) | 0;
					b[c >> 1] = (f + 32768 | 0) >>> 16;
					c = f >>> 16 & 65535;
					f = f >>> 1 & 32767;
					j = j + 1 | 0;
			...
			function Ta(a, c, d) {
				...
				while (1) {
					...
					f = N(f << 16 >> 16, -16042) | 0;
					g = b[a >> 1] | 0;
					j = (N(h << 16 >> 16, -16212) | 0) + ((i << 16 >> 16) * 32422 | 0) + f + (k >> 14) + (((g << 16 >> 16) + (j << 16 >> 16) | 0) * 8106 | 0) | 0;
					k = j << 2;
					f = j >>> 14;
					c = f & 65535;
					f = (k - (f << 16) | 0) >>> 1 & 65535;
			...
			function Ua(a, d, e) {
				...
				k = (b[(c[8 + (d << 2) >> 2] | 0) + (f << 1) >> 1] & (a & 65535) ^ b[k + (f << 1) >> 1] | g) << 16 >> 16 == 0 & 1;
				l = n;
				return k | 0
			}
			...
			function Ya(a) {
				...
				while (1) {
					...
					D = (b[H + (d + -2 << 1) >> 1] | 0) - i | 0;
					ba = D >> 31;
					da = N(((D >> 15 | 0) == (ba | 0) ? D : ba ^ 32767) << 16 >> 16, ((ca >> 15 | 0) == (da | 0) ? ca : da ^ 32767) << 16 >> 16) | 0;
			...
			function ab(a, c, d, e, f, g) {
				...
				if (g << 16 >> 16) {
					if (!(r << 16 >> 16 < 10 & p << 16 >> 16 > 8192)) {
						if (!(s << 16 >> 16 > 8192 & q << 16 >> 16 > 8192)) {
							...
							t = f >> 31;
							x = (((f >> 30 | 0) == (t | 0) ? f >>> 15 : t ^ 32767) << 16 >> 16) + (((h >> 30 | 0) == (x | 0) ? h >>> 15 : x ^ 32767) << 16 >> 16) | 0;
							h = x >> 31;
							h = ((x >> 15 | 0) == (h | 0) ? x : h ^ 32767) & 65535
						}
					} else h = b[e >> 1] | 0;
				...
				if ((p << 16 >> 16 < 6554 ? s << 16 >> 16 <= o << 16 >> 16 : 0) ? (j << 16 >> 16 > u << 16 >> 16 ? j << 16 >> 16 < v << 16 >> 16 : 0) : 0) {
					l = w;
					return
				}
			...
			function eb(e, f, g, h, i, j) {
				...
				if (n << 16 >> 16) {
					...
					while (1) {
						m = d[p >> 0] | 0;
						do
						switch (((m & 240) + -16 | 0) >>> 4 & 268435455 | 0) {
						case 14:
							{
								b[f + (b[o >> 1] << 1) >> 1] = 127;
								b[f + (b[o + 2 >> 1] << 1) >> 1] = 127;
						...
						k = o + 8 | 0;
						do
						switch (((m << 4 & 240) + -16 | 0) >>> 4 & 268435455 | 0) {
						case 14:
							{
								b[f + (b[k >> 1] << 1) >> 1] = 127;
			...
			function gb(a) {
				...
				var b = 0,
					c = 0;
				do
				if ((a | 0) <= 268435455) if ((a | 0) <= 16777215) {
					if ((a | 0) > 65535) {
						b = (a | 0) > 1048575 ? 7 : 11;
						break
					}
			...
			function kb(a, c, d, e, f, g) {
				...
				r = (a << 16 >> 16) - c | 0;
				q = r >> 31;
				if ((((r >> 15 | 0) == (q | 0) ? r : q ^ 32767) & 65535) << 16 >> 16 > (((c << 17 >> 17 | 0) == (c | 0) ? c << 1 : c >>> 15 ^ 32767) & 65535) << 16 >> 16) h = h + (n & 1) << 16 >> 16;
				else {
					h = ((((((m & 1) + (l << 16 >> 16 < 9830 & 1) << 16 >> 16) + (k << 16 >> 16 < 9830 & 1) << 16 >> 16) + (j << 16 >> 16 < 9830 & 1) << 16 >> 16) + (i << 16 >> 16 < 9830 & 1) << 16 >> 16) + (o << 16 >> 16 < 9830 & 1) & 65535) > 2 ? 0 : h;
			...
			function rb(d, f, g, h, i, j, k) {
				...
				while (1) {
					...
					if (!(h << 16 >> 16)) {
						...
						o = 0;
						do {
							b[Ia + (o << 1) >> 1] = (((((b[Ca + (j + o << 1) >> 1] | 0) + (b[Ca + (h + o << 1) >> 1] | 0) | 0) * 5898 | 0) + ((b[Ca + (o + C << 1) >> 1] | 0) * 20972 | 0) << 1) + 32768 | 0) >>> 16;
							o = o + 1 | 0
						} while ((o | 0) != 64);
						u = x;
						j = Ia;
					...
					while (0);
					nb(Ia, b[aa >> 1] | 0, 64);
					lb(Ia, (b[Ra >> 1] | 0) + (p << 16 >> 16 > 2 & 1) << 16 >> 16, 27853, 64);
					if (n) {
						z = Oa(6, Ta) | 0;
					...
					s = (h | 0) == 2147483647 ? 32767 : (h + 32768 | 0) >>> 16 & 65535;
					z = o & 65535;
					Gb(x + -496 | 0, 312, z - (e[fa >> 1] | 0) & 65535);
					b[fa >> 1] = o;
					if (ga) {
						b[T >> 1] = b[S >> 1] | 0;
						b[S >> 1] = b[U >> 1] | 0;
					...
					if (n) {
						...
						if (p << 16 >> 16 > 16384) {
							...
							do {
								...
								b[Ja + (j << 1) >> 1] = (w | 0) == 1073741824 ? 16384 : ((w << 1 >> 1) + 32768 | 0) >>> 16 & 65535;
								j = j + 1 | 0
							} while ((j | 0) != 64);
							w = p
						} else w = p
					} else w = 0;
					v = (Ib(Wa, -3, r, Ia, s, 64) | 0) << 16 >> 16;
					b[aa >> 1] = (v >>> 2) + 8192;
					u = Wa;
					j = x;
					t = u + 128 | 0;
					...
					r = o << 16 >> 16;
					u = ((((gb(q) | 0) & 65535) << 16) + -1048576 >> 16) + r | 0;
					x = u >> 31;
					b[ia >> 1] = b[ha >> 1] | 0;
					b[ha >> 1] = b[ja >> 1] | 0;
					b[ja >> 1] = b[ea >> 1] | 0;
					b[ea >> 1] = ((u >> 15 | 0) == (x | 0) ? u : x ^ 32767) + 65535;
					switch (d << 16 >> 16) {
					case 0:
					case 9:
						{
					...
					kb((c[Ua >> 2] | 0) >>> 16 & 65535, b[Sa >> 1] | 0, Ia, h, ka, k);
					p = N(16384 - (v >>> 1) << 16 >> 16, E) | 0;
					j = p >> 31;
					j = (p >> 30 | 0) == (j | 0) ? p >>> 15 : j ^ 32767;
					p = c[Ua >> 2] | 0;
					h = c[F >> 2] | 0;
					q = ((p | 0) < 0) << 31 >> 31;
					if ((p | 0) < (h | 0)) {
					...
					u = j << 16;
					x = 32767 - j << 16;
					x = bc(p | 0, q | 0, x | 0, ((x | 0) < 0) << 31 >> 31 | 0) | 0;
					x = cc(x | 0, y | 0, 31) | 0;
					t = y;
					u = bc(h | 0, ((h | 0) < 0) << 31 >> 31 | 0, u | 0, ((u | 0) < 0) << 31 >> 31 | 0) | 0;
					u = cc(u | 0, y | 0, 31) | 0;
					h = (x & -2) + (u & -2) | 0;
					h = (x ^ u | 0) > -1 & (h ^ x | 0) < 0 ? x >> 31 ^ 2147483647 : h;
					c[Ua >> 2] = h;
					if (o << 16 >> 16 > 0) {
						x = h << r;
					...
					j = (r & 65535) << 16;
					p = b[G >> 1] | 0;
					t = (v >>> 3 << 16) + 268435456 >> 16;
					v = N(t, p << 16 >> 16) | 0;
					v = (v | 0) == 1073741824 ? 2147483647 : v << 1;
					x = j - v | 0;
					x = ((x ^ j) & (v ^ j) | 0) < 0 ? j >> 31 ^ 2147483647 : x;
					h = (h | 0) == 2147483647 ? 32767 : h + 32768 >> 16;
					x = N((x | 0) == 2147483647 ? 32767 : x + 32768 >> 16, h) | 0;
					x = (x | 0) == 1073741824 ? 2147483647 : x << 1;
					j = x << 5;
					x = (j >> 5 | 0) == (x | 0) ? j : x >> 31 ^ 2147483647;
					j = b[Sa >> 1] | 0;
					v = N(j, b[Wa >> 1] | 0) | 0;
					v = (v | 0) == 1073741824 ? 2147483647 : v << 1;
					s = x + v | 0;
					s = (x ^ v | 0) > -1 & (s ^ x | 0) < 0 ? x >> 31 ^ 2147483647 : s;
					x = s << 1;
					s = (x >> 1 | 0) == (s | 0) ? x : s >> 31 ^ 2147483647;
					b[Wa >> 1] = (s | 0) == 2147483647 ? 32767 : (s + 32768 | 0) >>> 16 & 65535;
					s = 1;
					while (1) {
						v = (p & 65535) << 16;
						x = s;
					...
					x = (x | 0) == 1073741824 ? 2147483647 : x << 1;
					v = u - x | 0;
					v = ((v ^ u) & (x ^ u) | 0) < 0 ? u >> 31 ^ 2147483647 : v;
					v = N((v | 0) == 2147483647 ? 32767 : v + 32768 >> 16, h) | 0;
					v = (v | 0) == 1073741824 ? 2147483647 : v << 1;
					u = v << 5;
					v = (u >> 5 | 0) == (v | 0) ? u : v >> 31 ^ 2147483647;
					u = N(j, b[J >> 1] | 0) | 0;
					u = (u | 0) == 1073741824 ? 2147483647 : u << 1;
					x = v + u | 0;
					x = (v ^ u | 0) > -1 & (x ^ v | 0) < 0 ? v >> 31 ^ 2147483647 : x;
					v = x << 1;
					x = (v >> 1 | 0) == (x | 0) ? v : x >> 31 ^ 2147483647;
					b[J >> 1] = (x | 0) == 2147483647 ? 32767 : (x + 32768 | 0) >>> 16 & 65535;
					if (n & w << 16 >> 16 > 16384) {
						h = 0;
						do {
							x = Ja + (h << 1) | 0;
					...
					Hb(D, Wa, o, g + ((C >> 2) + C << 1) | 0, h, bb, cb, 0, i, Qa, k);
					j = C + 64 | 0;
					B = j & 65535;
			...
			function xb(a, c) {
				...
				d = c << 16 >> 16 >> 10 << 16 >> 16;
				f = b[7710 + (d << 1) >> 1] | 0;
				d = (f << 15) - (N(f - (e[7710 + (d + 1 << 1) >> 1] | 0) << 16 >> 16, c << 16 >> 16 << 5 & 32736) | 0) | 0;
				a = 29 - (a & 65535) | 0;
				c = a << 16 >> 16;
			...
			function Db(a, c, d, f, g, h, i) {
				...
				if (!(h << 16 >> 16)) {
					...
					do {
						...
						D = C >> 31;
						E = (((C >> 30 | 0) == (D | 0) ? C >>> 15 : D ^ 32767) << 16 >> 16) + (((F >> 30 | 0) == (E | 0) ? F >>> 15 : E ^ 32767) << 16 >> 16) | 0;
						F = E >> 31;
			...
			function Fb(a, c, d, e, f, g, h) {
				...
				if (!(g << 16 >> 16)) {
					...
					z = a + 2 | 0;
					g = a + 8 | 0;
					p = (b[23172 + ((b[g >> 1] | 0) * 7 << 1) >> 1] | 0) + (b[14916 + ((b[z >> 1] | 0) * 7 << 1) >> 1] | 0) | 0;
					A = p >> 31;
					x = c + 18 | 0;
					b[x >> 1] = (p >> 15 | 0) == (A | 0) ? p : A ^ 32767;
					A = (b[23172 + (((b[g >> 1] | 0) * 7 | 0) + 1 << 1) >> 1] | 0) + (b[14916 + (((b[z >> 1] | 0) * 7 | 0) + 1 << 1) >> 1] | 0) | 0;
					p = A >> 31;
					e = c + 20 | 0;
					b[e >> 1] = (A >> 15 | 0) == (p | 0) ? A : p ^ 32767;
					p = (b[23172 + (((b[g >> 1] | 0) * 7 | 0) + 2 << 1) >> 1] | 0) + (b[14916 + (((b[z >> 1] | 0) * 7 | 0) + 2 << 1) >> 1] | 0) | 0;
					A = p >> 31;
					i = c + 22 | 0;
					b[i >> 1] = (p >> 15 | 0) == (A | 0) ? p : A ^ 32767;
					A = (b[23172 + (((b[g >> 1] | 0) * 7 | 0) + 3 << 1) >> 1] | 0) + (b[14916 + (((b[z >> 1] | 0) * 7 | 0) + 3 << 1) >> 1] | 0) | 0;
					p = A >> 31;
					j = c + 24 | 0;
					b[j >> 1] = (A >> 15 | 0) == (p | 0) ? A : p ^ 32767;
					p = (b[23172 + (((b[g >> 1] | 0) * 7 | 0) + 4 << 1) >> 1] | 0) + (b[14916 + (((b[z >> 1] | 0) * 7 | 0) + 4 << 1) >> 1] | 0) | 0;
					A = p >> 31;
					k = c + 26 | 0;
					b[k >> 1] = (p >> 15 | 0) == (A | 0) ? p : A ^ 32767;
					A = (b[23172 + (((b[g >> 1] | 0) * 7 | 0) + 5 << 1) >> 1] | 0) + (b[14916 + (((b[z >> 1] | 0) * 7 | 0) + 5 << 1) >> 1] | 0) | 0;
					p = A >> 31;
					n = c + 28 | 0;
					b[n >> 1] = (A >> 15 | 0) == (p | 0) ? A : p ^ 32767;
					z = (b[23172 + (((b[g >> 1] | 0) * 7 | 0) + 6 << 1) >> 1] | 0) + (b[14916 + (((b[z >> 1] | 0) * 7 | 0) + 6 << 1) >> 1] | 0) | 0;
					g = z >> 31;
					p = c + 30 | 0;
					...
					do {
						...
						B = A >> 31;
						C = (((A >> 30 | 0) == (B | 0) ? A >>> 15 : B ^ 32767) << 16 >> 16) + (((D >> 30 | 0) == (C | 0) ? D >>> 15 : C ^ 32767) << 16 >> 16) | 0;
						D = C >> 31;
			...
			function Hb(d, f, g, h, i, j, k, n, o, p, q) {
				...
				u = r << 16 >> 16;
				if ((b[o + 1518 >> 1] | 0) > 0) r = (((r << 17 >> 17 | 0) == (u | 0) ? r << 1 : u >>> 15 ^ 32767) << 16 >> 16) + -1 | 0;
			...
			function Mb(a) {
				...
				if (!(c[6136] & 4)) {
					...
					if (d) {
						...
						while (1) {
							a = c[e >> 2] | 0;
							if (a >>> 0 <= d >>> 0 ? (t = e + 4 | 0, (a + (c[t >> 2] | 0) | 0) >>> 0 > d >>> 0) : 0) break;
							a = c[e + 8 >> 2] | 0;
							if (!a) {
								w = 118;
								break c
					...
					if ((w | 0) == 118) {
						d = gc(0) | 0;
						if ((d | 0) != (-1 | 0) ? (b = d, r = c[6144] | 0, s = r + -1 | 0, b = ((s & b | 0) == 0 ? 0 : (s + b & 0 - r) - b | 0) + n | 0, r = c[6133] | 0, s = b + r | 0, b >>> 0 > o >>> 0 & b >>> 0 < 2147483647) : 0) {
							t = c[6135] | 0;
					...
					if ((w | 0) == 126) {
						d = 0 - b | 0;
						if (!(j >>> 0 > b >>> 0 & (b >>> 0 < 2147483647 & (e | 0) != (-1 | 0)))) if ((e | 0) == (-1 | 0)) {
							b = 0;
							break
						} else {
							h = b;
				...
				while (0);
				if (((w | 0) == 133 ? n >>> 0 < 2147483647 : 0) ? (g = gc(n | 0) | 0, t = gc(0) | 0, u = t - g | 0, v = u >>> 0 > (o + 40 | 0) >>> 0, !((g | 0) == (-1 | 0) | v ^ 1 | g >>> 0 < t >>> 0 & ((g | 0) != (-1 | 0) & (t | 0) != (-1 | 0)) ^ 1)) : 0) {
					h = v ? u : b;
					w = 135
				}
				if ((w | 0) == 135) {
					...
					if (j) {
						...
						if (((w | 0) == 143 ? (c[b + 12 >> 2] & 8 | 0) == 0 : 0) ? g >>> 0 > j >>> 0 & a >>> 0 <= j >>> 0 : 0) {
							c[d >> 2] = e + h;
							x = (c[6028] | 0) + h | 0;
							v = j + 8 | 0;
							v = (v & 7 | 0) == 0 ? 0 : 0 - v & 7;
			...
			function Tb(b, d, e) {
				...
				f = g;
				c[b + 36 >> 2] = 3;
				if ((c[b >> 2] & 64 | 0) == 0 ? (c[f >> 2] = c[b + 60 >> 2], c[f + 4 >> 2] = 21523, c[f + 8 >> 2] = g + 16, da(54, f | 0) | 0) : 0) a[b + 75 >> 0] = -1;
				f = Ub(b, d, e) | 0;
				l = g;
				return f | 0
			}
			...
			function _b(a) {
				...
				b = a + 20 | 0;
				h = a + 28 | 0;
				if ((c[b >> 2] | 0) >>> 0 > (c[h >> 2] | 0) >>> 0 ? (ka[c[a + 36 >> 2] & 3](a, 0, 0) | 0, (c[b >> 2] | 0) == 0) : 0) a = -1;
				else {
					d = a + 4 | 0;
					e = c[d >> 2] | 0;
					f = a + 8 | 0;
